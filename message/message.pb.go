...
type DataRequest struct {
	...
	MessageTs int64  `protobuf:"varint,4,opt,name=message_ts,json=messageTs,proto3" json:"message_ts,omitempty"`
}
...
func (x *DataRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *DataRequest) GetNickname() string {
	if x != nil {
		return x.Nickname
	}
	return ""
...
func (x *DataRequest) GetMessageTs() int64 {
	if x != nil {
		return x.MessageTs
	}
	return 0
...
var file_message_message_proto_rawDesc = []byte{
	...
	0x22, 0x7b, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	,
...
var file_message_message_proto_goTypes = []interface{}{
	(*DataRequest)(nil),  // 0: message.DataRequest
	(*DataResponse)(nil), // 1: message.DataResponse
}
var file_message_message_proto_depIdxs = []int32{
	0, // 0: message.MessageService.SendData:input_type -> message.DataRequest
	1, // 1: message.MessageService.SendData:output_type -> message.DataResponse
